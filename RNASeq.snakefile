...
rule generate_report:
    ...
    run:
        ...
        report(sphinx_str, output[0], metadata="Molecular Biology Core Facilities, DFCI", **{'Copyrights:':"./snakemake/mbcf.jpg"})
...
#        "scripts/DEseq.R"
    ...
    run:
        shell("Rscript snakemake/scripts/DEseq.R \"{input.counts}\" \"{params.s1}\" \"{params.s2}\" {output.limma} {output.deseq} {output.deseqSum} {params.gene_annotation}")
